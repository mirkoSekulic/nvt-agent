...
The coordinated release builds or verifies all nine production image tags from
the same commit, proves that each is anonymously readable, and publishes the
chart last.
