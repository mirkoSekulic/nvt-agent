...
of, upgrading to chart `0.8.24`; otherwise the API server will prune or reject
...
```sh
helm show crds oci://ghcr.io/mirkosekulic/helm/nvt --version 0.8.24 \
  | kubectl apply --server-side -f -

helm upgrade --install nvt oci://ghcr.io/mirkosekulic/helm/nvt \
  --version 0.8.24 --namespace nvt --create-namespace
```
