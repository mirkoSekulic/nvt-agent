...
grep -Fxq 'share/examples/native-capture.json' <<<"${archive_listing}"
grep -Fxq 'share/systemd/nvt-guest-egress.service' <<<"${archive_listing}"
grep -Fxq 'share/systemd/nvt-guest-captured.service' <<<"${archive_listing}"
grep -Fxq 'bin/nvt-guest-egressd' <<<"${archive_listing}"
grep -Fxq 'bin/nvt-guest-captured' <<<"${archive_listing}"
